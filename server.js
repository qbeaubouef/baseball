...
const DEFAULT_TEAMS = {
  ...
  ATL: { city: 'Atlanta',      name: 'Braves',     abbr: 'ATL', league: 'NL', div: 'East',    primary: '#13274F', secondary: '#FFFFFF', ink: '#FFFFFF', mlbId: 144 },
  ...
  CLE: { city: 'Cleveland',    name: 'Guardians',  abbr: 'CLE', league: 'AL', div: 'Central', primary: '#00385D', secondary: '#FF0000', ink: '#FFFFFF', mlbId: 114 },
  ...
  LAA: { city: 'Los Angeles',  name: 'Angels',     abbr: 'LAA', league: 'AL', div: 'West',    primary: '#BA0021', secondary: '#FFFFFF', ink: '#FFFFFF', mlbId: 108 },
  LAD: { city: 'Los Angeles',  name: 'Dodgers',    abbr: 'LAD', league: 'NL', div: 'West',    primary: '#005A9C', secondary: '#FFFFFF', ink: '#FFFFFF', mlbId: 119 },
  MIA: { city: 'Miami',        name: 'Marlins',    abbr: 'MIA', league: 'NL', div: 'East',    primary: '#00A3E0', secondary: '#000000', ink: '#FFFFFF', mlbId: 146 },
  MIL: { city: 'Milwaukee',    name: 'Brewers',    abbr: 'MIL', league: 'NL', div: 'Central', primary: '#12284B', secondary: '#FFC52F', ink: '#FFFFFF', mlbId: 158 },
  MIN: { city: 'Minnesota',    name: 'Twins',      abbr: 'MIN', league: 'AL', div: 'Central', primary: '#002B5C', secondary: '#B9975B', ink: '#FFFFFF', mlbId: 142 },
  NYM: { city: 'New York',     name: 'Mets',       abbr: 'NYM', league: 'NL', div: 'East',    primary: '#002D72', secondary: '#FF5910', ink: '#FFFFFF', mlbId: 121 },
  NYY: { city: 'New York',     name: 'Yankees',    abbr: 'NYY', league: 'AL', div: 'East',    primary: '#0C2340', secondary: '#A5ACAF', ink: '#FFFFFF', mlbId: 147 },
  OAK: { city: 'Athletics',    name: 'Athletics',  abbr: 'ATH', league: 'AL', div: 'West',    primary: '#003831', secondary: '#EFB21E', ink: '#FFFFFF', mlbId: 133 },
  PHI: { city: 'Philadelphia', name: 'Phillies',   abbr: 'PHI', league: 'NL', div: 'East',    primary: '#E81828', secondary: '#FFFFFF', ink: '#FFFFFF', mlbId: 143 },
  ...
  SEA: { city: 'Seattle',      name: 'Mariners',   abbr: 'SEA', league: 'AL', div: 'West',    primary: '#005C5C', secondary: '#C4CED4', ink: '#FFFFFF', mlbId: 136 },
  STL: { city: 'St. Louis',    name: 'Cardinals',  abbr: 'STL', league: 'NL', div: 'Central', primary: '#C41E3A', secondary: '#FEDB00', ink: '#FFFFFF', mlbId: 138 },
  TB:  { city: 'Tampa Bay',    name: 'Rays',       abbr: 'TB',  league: 'AL', div: 'East',    primary: '#092C5C', secondary: '#8FBCE6', ink: '#FFFFFF', mlbId: 139 },
  TEX: { city: 'Texas',        name: 'Rangers',    abbr: 'TEX', league: 'AL', div: 'West',    primary: '#003278', secondary: '#FF0000', ink: '#FFFFFF', mlbId: 140 },
  TOR: { city: 'Toronto',      name: 'Blue Jays',  abbr: 'TOR', league: 'AL', div: 'East',    primary: '#134A8E', secondary: '#FFFFFF', ink: '#FFFFFF', mlbId: 141 },
  WSH: { city: 'Washington',   name: 'Nationals',  abbr: 'WSH', league: 'NL', div: 'East',    primary: '#AB0003', secondary: '#FFFFFF', ink: '#FFFFFF', mlbId: 120 },
};
